                ...
                ?>
                  <div class="card">
                    <div class="card-header">
                      <h4>Edit Product
                      <a href="products.php" class="btn btn-primary float-end">Back <i class="material-icons" id="extrabtn">arrow_back</i></a>
                      </h4>
                    </div>
                    <div class="card-body">
                      <form action="code.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                              ...
                              <textarea rows="5" required name="description" placeholder="Enter description" class="form-control mb-2"><?= $data['description']; ?></textarea>
                          </div>
                          <div class="col-md-6">
                          ...
                          <div class="col-md-12">
                              ...
                              <img src="../uploads/<?= $data['image']; ?>" alt="Product Image" height="50px" width="40px">
                          ...
                          <div class="col-md-3">
                              <label class="mt-4">Trending</label>
