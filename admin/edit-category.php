          ...
          ?>
            <div class="card">
              <div class="card-header">
                <h4>Edit Category
                  <a href="category.php" class="btn btn-primary float-end">Back <i class="material-icons" id="extrabtn">arrow_back</i></a>
                </h4>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <input type="hidden" name="category_id" value="<?= $data['id'] ?>">
                        ...
                        <input type="text" name="name" value="<?= $data['name'] ?>" placeholder="Enter Categories Name" class="form-control">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <img src="../uploads/<?= $data['image'] ?>" height="50px" width="40px"  alt="">
