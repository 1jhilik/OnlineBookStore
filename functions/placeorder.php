...
if(isset($_SESSION['auth']))
{
  ...
  if(isset($_POST['placeOrderBtn']))
  {
      ...
      $tracking_no = "jhilikcoder".rand(1111,9999).substr($phone,2);
      ...
      if($insert_query_run)
      {
        ...
        foreach ($query_run as $citem)
        {
          ...
          $updatQty_query = "UPDATE products SET qty= '$new_qty' WHERE id='$prod_id'";
          $updatQty_query_run = mysqli_query($con, $updatQty_query);
        }
