...
<div class="py-3 bg-primary">
      <div class="container">
        ...
        <a class="text-white" href="index.php">
              ...
              <a class="text-white" href="my-order.php">
              My Orders /
              </a>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card-header bg-primary">
                    ...
                    <a href="my-order.php" class="btn btn-warning float-start"> <i class="fa fa-reply"></i> Back</a>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                                      ...
                                      ?>
                                          <tr>
                                            <td class="align-middle">
                                              <img src="uploads/<?=$item['image'] ?>" alt="<?=$item['name'] ?>" width="40px" class="m-2 shadow">
                                              <?=$item['name'] ?>
                                            </td>
                                            <td class="align-middle">
                                              <?=$item['orderqty'] ?>
                          ...
                          <hr>
                          <h5>Total Price: <span class="float-start ms-5 fw-bold">$ <?= $data['total_price'] ?></span></h5>
                          <hr>
